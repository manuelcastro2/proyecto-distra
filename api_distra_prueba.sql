...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 29-06-2023 a las 16:38:47
...
CREATE TABLE `filtros` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `filtros` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `filtros` (`id`, `filtros`, `marca`, `modelo`, `created_at`, `updated_at`) VALUES
...
(6, 'filtro de combsustible', 'mazda', 'mazda3', '2023-06-29 03:08:48', '2023-06-29 03:08:48'),
(7, 'filtros cabina', 'suzuki', 'vitara 4x4', '2023-06-29 03:09:28', '2023-06-29 03:09:28'),
...
ALTER TABLE `filtros`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `filtros_marca_unique` (`marca`);
